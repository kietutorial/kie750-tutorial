package com.aikiinc.hello.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("kieandjhipster");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("kieandjhipster");
        ...
        config.getMapConfigs().put("com.aikiinc.hello.domain.*", initializeDomainMapConfig(jHipsterProperties));
