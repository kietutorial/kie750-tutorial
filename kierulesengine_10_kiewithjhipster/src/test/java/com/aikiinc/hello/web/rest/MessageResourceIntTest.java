...
import static com.aikiinc.hello.web.rest.TestUtil.createFormattingConversionService;
...
public class MessageResourceIntTest {
    ...
    private static final StatusType DEFAULT_STATUS = StatusType.HELLO;
    private static final StatusType UPDATED_STATUS = StatusType.GOODBYE;
